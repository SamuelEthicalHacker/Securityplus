...
El propósito de este dominio es establecer el vocabulario y los principios fundamentales que rigen todas las decisiones de seguridad, desde la arquitectura hasta las operaciones diarias.
...
- Modelos básicos de control de acceso y AAA
- Tipos de controles
- Soluciones criptográficas (mini-labs en su propia carpeta)


Estructura oficial:

- 01_SecurityPrinciples/
- 02_AccessControlModels/
- 03_Authentication_Authorization/
- 04_SecurityControls/
- 05_Cryptographic_Solutions/
