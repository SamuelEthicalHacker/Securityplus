...
|------------------------|-------------------------------|-------------------------|------------------------------|
| Atacante externo       | Software desactualizado       | Gestión de parches      | Reducción de explotación     |
| Insider threat         | Exceso de privilegios         | Control de acceso       | Mínimo privilegio            |
| Malware                | Endpoint sin protección       | Aislamiento             | Contención de amenaza        |
| Ataque de red          | Red plana                     | Segmentación            | Limitación de movimiento     |
